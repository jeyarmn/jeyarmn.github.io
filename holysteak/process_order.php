...
<div class="content">
	<div class="container-fluid">
		<div class='row'>
			...
			?>
				<div class="container">
					<div class="alert alert-success my-5 py-5" style=background-color:#faf032;>
						...
						<h3 class="text-center">Explore more <a href="product.php" class="text-decoration-none fw-bolder"><b>Menu</b></a></h3>
					</div>
				</div>
			<?php } else { ?>
